...
export default (props) => {
    ...
    return (
        <div className='reg'>
            ...
            <form  onSubmit={props.regNewUser} className='reg__form'>
                ...
                <input name='log_email' type="email" placeholder="your-mail@mail.com" required onChange={props.handler}/>
                ...
                <input name='reg_avatar' type="text"  onChange={props.handler}/>
